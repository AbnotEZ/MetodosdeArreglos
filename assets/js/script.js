//TAREA
//1.- ID (NUMEROS CORRELATIVOS)(LISTO)
//2.- DESCRIPCION(LISTO)
//3.- ESTADO PENDIENTE O REALIZADO(LISTO)
//INGRESAR UNA TAREA CON UN BOTON
//1.- ARREGLOS
//2.- TEMPLETE DE LO QUIERO MOSTRAR(LISTO)
//3.- BOTON FUNCION PARA INGRESAR TAREA (LISTO)
//4.- INPUT PARA INGRESAR TAREA (LISTO)
//5.- MOSTRAR TAREA INNER HTML(LISTO)
...
//1.- VER LA FORMA DE VER LO FILTRADO EN EL HTML(LISTO)
...
const tareas = [
  { id: 1, description: "lavar la loza", estado: false },
  { id: 2, description: "limpiar", estado: false },
  { id: 3, description: "lavarme los dientes", estado: false },
];
